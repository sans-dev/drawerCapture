...
class RegionField(QWidget):
    ...
    def init_ui(self):
        ...
        self.region_input.setFixedHeight(30)
...
class GeoCoordinatesField(QWidget):
    ...
    def init_ui(self):
        ...
        longitude_label.setFixedHeight(30)
        self.longitude_input = QDoubleSpinBox()
        self.longitude_input.setFixedHeight(30)
        ...
        lattitude_label.setFixedHeight(30)
        self.lattitude_input = QDoubleSpinBox()
        self.lattitude_input.setFixedHeight(30)
